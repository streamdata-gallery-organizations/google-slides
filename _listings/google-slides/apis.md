...
- name: Google Slides API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/google-slides/master/_listings/google-slides/v1-presentations-presentationid-batchupdate-post.md
x-common:
- type: x-developer
